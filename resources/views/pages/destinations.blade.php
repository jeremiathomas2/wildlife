...
@section('content')
    ...
    <section class="relative h-[50vh] min-h-[320px] flex items-end pb-16">
        <div class="absolute inset-0">
            <img src="https://res.cloudinary.com/aenplcpl/image/upload/f_auto,q_auto,w_1920/v1782890323/safari-serengeti_agwjrp.jpg" alt="Safari" class="w-full h-full object-cover">
