...
<head>
    ...
    <!-- Primary Meta Tags -->
    <title><?php echo $__env->yieldContent('title', 'Tanzania Daily Tours & Safari - Best Safari & Tours in Tanzania'); ?></title>
    <meta name="title" content="<?php echo $__env->yieldContent('meta_title', 'Tanzania Daily Tours & Safari - Best Safari & Tours in Tanzania'); ?>">
    <meta name="description" content="<?php echo $__env->yieldContent('meta_description', 'Experience the best of Tanzania with expert-guided safaris, cultural tours, and Kilimanjaro adventures. Explore Serengeti, Ngorongoro, Zanzibar & more!'); ?>">
    <meta name="keywords" content="<?php echo $__env->yieldContent('meta_keywords', 'Tanzania Daily Tours & Safari, Tanzania Daily Tour, Tanzania Daily Safari, Tanzania safari, Tanzania tours, Tanzania safari packages, Serengeti safari, Serengeti tours, Mount Kilimanjaro climbing, Zanzibar holidays, Tanzania travel, Tanzania wildlife safari, Ngorongoro safari, Tarangire National Park, Mikumi safari, Ruaha safari, Tanzania honeymoon safari, Family safari Tanzania, Luxury safari Tanzania, Budget safari Tanzania'); ?>">
    ...
    <meta property="og:title" content="<?php echo $__env->yieldContent('meta_title', 'Tanzania Daily Tours & Safari - Best Safari & Tours in Tanzania'); ?>">
    <meta property="og:description" content="<?php echo $__env->yieldContent('meta_description', 'Experience the best of Tanzania with expert-guided safaris, cultural tours, and Kilimanjaro adventures. Explore Serengeti, Ngorongoro, Zanzibar & more!'); ?>">
    <meta property="og:image" content="<?php echo $__env->yieldContent('meta_image', 'https://res.cloudinary.com/aenplcpl/image/upload/v1782890323/safari-serengeti_agwjrp.jpg'); ?>">
    ...
    <meta name="twitter:title" content="<?php echo $__env->yieldContent('meta_title', 'Tanzania Daily Tours & Safari - Best Safari & Tours in Tanzania'); ?>">
    <meta name="twitter:description" content="<?php echo $__env->yieldContent('meta_description', 'Experience the best of Tanzania with expert-guided safaris, cultural tours, and Kilimanjaro adventures. Explore Serengeti, Ngorongoro, Zanzibar & more!'); ?>">
    <meta name="twitter:image" content="<?php echo $__env->yieldContent('meta_image', 'https://res.cloudinary.com/aenplcpl/image/upload/v1782890323/safari-serengeti_agwjrp.jpg'); ?>">
...
<body>
    ...
    <nav class="fixed top-0 left-0 right-0 z-50 transition-all duration-400" id="mainNav">
        <div class="max-w-[1280px] mx-auto px-6 flex items-center justify-between" style="height: 72px;">
            ...
            <a href="<?php echo e(route('home')); ?>" class="flex items-center gap-3" style="transition: all 0.4s ease;">
            ...
            <div class="hidden lg:flex items-center gap-8">
                <?php $__currentLoopData = $navLinks; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $link): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <a href="<?php echo e(route($link['route'])); ?>" 
                       ...
                       style="
                           color: <?php echo e($currentRoute === $link['route'] ? '#ff9729' : '#ffffff'); ?>; 
                           font-family: 'Raleway', sans-serif;
                           transition: all 0.3s ease;
                       "
                       onmouseover="this.querySelector('span').style.width = '100%'; this.querySelector('span').style.left = '0';"
                       onmouseout="this.querySelector('span').style.width = '<?php echo e($currentRoute === $link['route'] ? '100%' : '0'); ?>'; this.querySelector('span').style.left = '<?php echo e($currentRoute === $link['route'] ? '0' : '50%'); ?>';"
                    >
                        <?php echo e($link['label']); ?>

                        <span class="absolute bottom-0 h-0.5" style="
                            background: #ff9729;
                            left: <?php echo e($currentRoute === $link['route'] ? '0' : '50%'); ?>;
                            width: <?php echo e($currentRoute === $link['route'] ? '100%' : '0'); ?>;
                            transition: all 0.3s ease;
                        "></span>
                    </a>
            ...
            <div class="hidden lg:block">
                <a href="<?php echo e(route('destinations')); ?>" class="inline-flex items-center px-6 py-2.5 rounded-full text-sm font-semibold text-white transition-all duration-300 hover:opacity-90" style="background: #088529;">
                    Book a Trip
                </a>
            </div>
    ...
    <div id="mobileMenu" class="fixed inset-0 z-40 hidden flex-col bg-white" style="padding-top: 80px;">
        ...
        <div class="absolute top-0 left-0 right-0 px-6 flex items-center justify-between" style="height: 72px; background: #854208;">
            <a href="<?php echo e(route('home')); ?>" class="flex items-center gap-3" onclick="closeMobileMenu()">
        ...
        <div class="flex-1 overflow-y-auto bg-white">
            <?php $__currentLoopData = $navLinks; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $link): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <a href="<?php echo e(route($link['route'])); ?>" 
                   ...
                   style="
                       color: <?php echo e($currentRoute === $link['route'] ? '#ff9729' : '#854208'); ?>;
                       font-family: 'Raleway', sans-serif;
                       font-size: 18px;
                       font-weight: <?php echo e($currentRoute === $link['route'] ? '700' : '500'); ?>;
                       background: <?php echo e($currentRoute === $link['route'] ? 'rgba(255, 151, 41, 0.08)' : 'transparent'); ?>;
                   " 
                   onclick="closeMobileMenu()">
                    <span><?php echo e($link['label']); ?></span>
                    <svg xmlns="http://www.w3.org/2000/svg" class="w-5 h-5" style="color: <?php echo e($currentRoute === $link['route'] ? '#ff9729' : '#854208'); ?>;" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
                        <path d="M9 6l6 6-6 6"/>
                    </svg>
                </a>
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                ...
                <div>
                    ...
                    <ul class="space-y-2.5">
                        ...
                        <?php $__currentLoopData = $quickLinks; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $link): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <li>
                                <a href="<?php echo e(route($link['route'])); ?>" class="text-sm transition-colors duration-300 hover:text-white" style="color: rgba(255, 255, 255, 0.7);">
                                    <?php echo e($link['label']); ?>
                ...
                <div>
                    ...
                    <ul class="space-y-2.5">
                        ...
                        <?php $__currentLoopData = $popularTours; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $tour): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <li>
                                <a href="<?php echo e(route('destinations')); ?>" class="text-sm transition-colors duration-300 hover:text-white" style="color: rgba(255, 255, 255, 0.7);">
                                    <?php echo e($tour); ?>
        ...
        <div class="border-t" style="border-color: rgba(255, 255, 255, 0.15);">
            <div class="max-w-[1280px] mx-auto px-6 py-5 flex flex-col sm:flex-row items-center justify-between gap-2">
                <p class="text-xs" style="color: rgba(255, 255, 255, 0.6);">
                    &copy; <?php echo e(date('Y')); ?> Tanzania Daily Tours & Safari. All rights reserved.
                </p>
                <div class="flex items-center gap-4">
                    <a href="<?php echo e(route('terms')); ?>" class="text-xs transition-colors duration-300 hover:text-white" style="color: rgba(255, 255, 255, 0.6);">
                        Terms of Service
                    </a>
                    <a href="<?php echo e(route('privacy')); ?>" class="text-xs transition-colors duration-300 hover:text-white" style="color: rgba(255, 255, 255, 0.6);">
                        Privacy Policy
                    </a>
                </div>
            </div>
...
<?php /**PATH C:\laragon\www\TDTS\resources\views/layouts/app.blade.php ENDPATH**/ ?>