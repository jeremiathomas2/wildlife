...
class SiteContentSeeder extends Seeder
{
    public function run(): void
    {
        ...
        SiteContent::updateOrCreate(
            ...
            ['label' => 'About Story Text', 'type' => 'html', 'group' => 'about', 'value' => '<p>Founded by local Tanzanian guides with deep-rooted knowledge of our country\'s spectacular national parks and diverse cultures, Tanzania Daily Tours and Safari was born out of a profound love for sharing our incredible homeland with visitors from around the world.</p><p>What began as a close-knit team of passionate wilderness guides has evolved into one of the region\'s most trusted boutique tour operators. With over a decade of collective experience, we have dedicated ourselves to crafting seamless, unforgettable expeditions—from the snow-capped summit of Mount Kilimanjaro to the endless, wildlife-rich plains of the Serengeti.</p><p>Our mission is simple: to connect you with the raw, authentic pulse of East Africa. We don\'t just show you the iconic postcard views; we invite you to experience the genuine warmth of our people, the rich depth of our cultural heritage, and the untamed beauty of our wild landscapes.</p>']
        );
